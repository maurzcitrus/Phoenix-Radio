...
/**
 * The RadioProgramSchedulesActivity Class which extends the PhoenixBaseActivity
...
public class RadioProgramSchedulesActivity extends PhoenixBaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_radio_program_schedules);
    initCommonUi();
  }

  /**
   * Calls the DisplayTargetRadioProgram Method in the Schedule Controller.
   *
   * @param savedInstanceState
   */
  ...
  protected void onPostCreate(@Nullable Bundle savedInstanceState) {
    ...
    ControlFactory.getSchedulesController().onDisplayTargetRadioProgram(this);
  }


  /**
   * Display the List of Schedules for respective RadioProgram in RecyclerView.
   *
   * @param slots
   */
